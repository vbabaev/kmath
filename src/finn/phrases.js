...
export const PHRASES = {
  ...
  assignmentsOne: [
    ...
    "One assignment waiting, {name}. Knock it out!",
  ...
  assignmentsMany: [
    ...
    "{count} tasks lined up, {name}. Let's knock 'em down!",
  ...
  interlude: [
    ...
    "Good job! Next one coming…",
    "Keep going, {name}!",
    "Sweet! Loading the next…",
    "Brain reset in progress…",
    "Awesome! One down.",
    "Great stretch for the brain!",
    "Shake it out, {name}…",
    "You're on a roll!",
    "Quick breather…",
    "Smooth! Next up…",
    ...
    "Reset complete — go!",
    "Brain gears engaged ⚙️",
    "Sharper by the second!",
    "Cool. Calm. Crushing it.",
  ],
  ...
  finish: [
    ...
    "Quiz cleared! Great brainwork, {name}!",
